...
/***/ function(module, exports, __webpack_require__) {
	...
	var Btn = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'a',
	      { href: this.props.href, className: 'btn {\'btn--\'+this.props.theme}' },
	      this.props.text
	    );
	  }
	});
	...
	var Headline = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'h1',
	      { className: this.props.theme ? "Headline--" + this.props.theme : "Headline" },
	      this.props.text
	    );
	  }
	});

	var Para = _react2.default.createClass({
	  displayName: 'Para',

	  render: function render() {
	    return _react2.default.createElement(
	      'p',
	      { className: 'para {\'para--\'+this.props.theme}' },
	      'This is from'
	    );
	  }
	});
	...
	//     render(){
	//      return (<p className="para {'para--'+this.props.theme}">{this.props.text}</p>);
	//     }
	//  }

	var Linkes = _react2.default.createClass({
	  displayName: 'Linkes',
	...
	var Hero = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var para = _props.para;
	    var primaryCta = _props.primaryCta;
	    var config = _props.config;
	    var likes = _props.likes;

	    return _react2.default.createElement(
	      'section',
	      { className: config.theme ? "hero hero--" + config.theme : "hero hero--default", id: config.id },
	      _react2.default.createElement(Headline, headline),
	      _react2.default.createElement(Para, para),
	      _react2.default.createElement(Btn, primaryCta),
	      _react2.default.createElement(Linkes, likes)
	    );
	  }
	});
	/*organisms end*/
	...
	_reactDom2.default.render(_react2.default.createElement(Hero, content), document.getElementById('app'));
